...
- **Sentinel-2 L2A:** Copernicus / ESA, streamed as cloud-optimized GeoTIFFs from the
  [Element84 Earth Search STAC](https://earth-search.aws.element84.com/) for the dNBR
  optical cross-validation (`validate_optical.py`).
...
- **SRTM 3Sec DEM** (terrain correction / geocoding): [NASA / USGS](https://www.earthdata.nasa.gov/),
  downloaded automatically by SNAP. Public domain; credited as a courtesy, no attribution is required.
